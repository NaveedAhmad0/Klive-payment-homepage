              ...
              <div class="col-12">
                <div class="content">
                  ...
                  <p>
                    ...
                    users to boost your online presence and custoer acquistion
            ...
            <div class="col-lg-4 col-md-6 col-12">
              <div class="pricing-style-fourteen">
                ...
                <div class="table-head">
                  <h5>Easy to use QR Codes</h5>
                  <p>
                    Quick, easy and secure. Payments Will never be the same
                    again. mobile and Desktop - no matter where you may be,
                    KlivePay Will alwayt your fingertips. be at your fingertips.
                  </p>
                  {/* <div class="price">
                  <h2 class="amount">
            ...
            <div class="col-lg-4 col-md-6 col-12">
              ...
              <FontAwesomeIcon
                ...
                <div class="table-head">
                  ...
                  <p>
                    KlivePay's platform is geared towards<br/>ensuring security an
                    protection<br/>for all our users<br/><br/>
                  </p>
                  {/* <div class="price">
                  <h2 class="amount">
            ...
            <div class="col-lg-4 col-md-6 col-12">
              ...
              <FontAwesomeIcon
                ...
                <div class="table-head">
                  ...
                  <p>
                    KlivePay's seamlessly platform<br/>allows for payments to be
                    received within 1<br/>business day<br/><br/>
                  </p>
                  {/* <div class="price">
                  <h2 class="amount">
